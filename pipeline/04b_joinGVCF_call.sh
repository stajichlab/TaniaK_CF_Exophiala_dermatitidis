#!/usr/bin/bash
#SBATCH --mem 32gb --nodes 1 -p short --ntasks 32 -J GATK.GVCFGeno --out logs/GVCFGeno.log 
...
if [ ! -f $OUT ]; then
	...
	echo "WARNING not re-running the job since there is already and $OUT file"
fi
