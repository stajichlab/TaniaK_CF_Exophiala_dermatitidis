#!/bin/bash
#SBATCH --nodes 1 --ntasks 24 --time 2:00:00 -p short --mem 64G --out mosdepth.alt1.parallel.log
#SBATCH -J modepth
...
#parallel --jobs $CPU mosdepth -f $REFGENOME -T 1,10,50,100,200 -n --by $GENEBED -t 2 "{= s:aln\/:coverage/mosdepth/:; s:\.bed:.${WINDOW}bp: =}" {} ::: aln/*.bed
